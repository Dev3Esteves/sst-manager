...
const CLAUSULAS: Clausula[] = [
  {
    ...
    itens: [
      ...
      { requisito: "4.3/4.4 Escopo e sistema de gestão de SST", como: "Módulo Contexto (/contexto): escopo do SGSST documentado (limites, aplicabilidade e exclusões) + estrutura multiempresa por obra e PGR.", status: "atende" },
    ],
  },
  {

...
export const empresaImport: ImportSchema<typeof empresaImportZod> = {
  ...
  colunas: [
    { key: "razao_social", label: "Razão Social", aliases: ["razao", "razaosocial"], exemplo: "Empresa Exemplo Ltda", obrigatorio: true },
    { key: "nome_fantasia", label: "Nome Fantasia", aliases: ["fantasia"], exemplo: "Empresa Exemplo" },
...
export const colaboradorImport: ImportSchema<typeof colaboradorImportZod> = {
  ...
  colunas: [
    ...
    { key: "email", label: "E-mail", aliases: ["e_mail"], exemplo: `joao@${brand.emailDomain}` },
